...
class CoMM(BaseModel):
    ...
    # Cambiato Extrcat_features perchè richiedeva etichette 
    ...
    def on_validation_epoch_end(self):
        ...
        image_embeds, _ = self.extract_features(val_loader, mask_modalities=[[True, False]])
        text_embeds, _ = self.extract_features(val_loader, mask_modalities=[[False, True]])
